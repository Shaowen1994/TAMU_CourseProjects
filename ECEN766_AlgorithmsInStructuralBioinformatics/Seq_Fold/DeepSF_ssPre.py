...
from library_ssPre import load_train_test_data_padding_with_interval,K_max_pooling1d,DLS2F_train_complex_win_filter_layer_opt
...
outputdir = '../Model/Seq_Fold/withSSpre'
