...
feature_dir_global =GLOBAL_PATH+'/Data/Datasets/For_Seq_Stru/features_mix'
...
def load_train_test_data_padding_with_interval(CV_dir, Interval,prefix,ktop_node,seq_end,real_portion,train=True):
    ...
    try:
        ...
        feature_dir = feature_dir_global + '_%d'%real_portion
        ...
        for i in range(len(sequence_file)):
            ...
            train_feature_ss = train_feature_seq[:,20:feature_dim]
...
def DLS2F_train_complex_win_filter_layer_opt(data_all_dict_padding,testdata_all_dict_padding,train_list,val_list,test_list,CV_dir,model_prefix,epoch_outside,epoch_inside,seq_end,win_array,use_bias,hidden_type,nb_filters,nb_layers,opt,hidden_num,ktop_node,real_portion):
